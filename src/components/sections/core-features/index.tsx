...
export function CoreFeatures() {
  return (
    <section id="solutions" className="py-30 bg-gray-50 dark:bg-white/1 px-5">
      <div className="max-w-[72rem] mx-auto">
        <div className="mb-12 text-center">
          <h2 className="mb-3 font-bold text-gray-800 text-3xl dark:text-white/90 md:text-title-lg max-w-xl mx-auto">
            What Nexvect Delivers
          </h2>

          <p className="max-w-xl mx-auto leading-6 text-gray-500 dark:text-gray-400">
            An AI-enabled ecosystem that connects vision, IoT, and workflows to
            help manufacturers run safer, faster, and with fewer surprises.
          </p>
        </div>
