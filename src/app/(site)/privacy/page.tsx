...
export const metadata: Metadata = {
  ...
  description:
    'Read the Nexvect Privacy Policy to understand how we collect, use, and protect your data when you use our AI manufacturing platform.',
  alternates: {
    canonical: 'https://nexvect.com/privacy',
  },
  robots: {
    index: true,
    follow: true,
    ...
    <section className="py-20">
      <div className="wrapper">
        <div className="max-w-[800px] mx-auto">
          ...
          <h1 className="mb-12 text-4xl font-semibold text-gray-800 dark:text-white/90">
            Privacy Policy
          </h1>
          <div className="mb-6">
